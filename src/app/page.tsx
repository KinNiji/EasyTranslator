...
export default function Home() {
  ...
  return <main className="app-shell" lang={uiLanguage}>
    ...
    <footer className="brand-footer"><div className="footer-meta"><span>EasyTranslator · {t('brandTagline')}</span><small>© 2026 Zheng Haoyu</small></div><Image src="/brand/china-aid.png" alt={t('chinaAidAlt')} width={800} height={246} /></footer>
